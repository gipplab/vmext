...
const path = require('path'),
      ...
      xpath = require('xpath'),
      PresentationMMLGenerator = require('./PresentationMMLGenerator');
...
module.exports = class XMLParser {
  ...
  parseApply(applyElement) {
    ...
    const opPresentationElement = PresentationMMLGenerator.hasOwnProperty(opName) ? PresentationMMLGenerator[opName]: this.getElementById(opXref);
